...
SyncTimeEntriesReq = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("SyncTimeEntriesReq").msgclass
SyncTimeEntriesResp = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("SyncTimeEntriesResp").msgclass